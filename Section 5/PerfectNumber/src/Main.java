public class Main {
    public static void main(String[] args) {
        /*
        * What is the perfect number? A perfect number is a positive integer which is equal
        ...
        * and the sum of its proper divisors is 1+2 +3 = 6. Therefore, 6 is a perfect number
        ...
        * */
        ...
        System.out.println(PerfectNumber.isPerfectNumber(6)); //expected output: true
        System.out.println(PerfectNumber.isPerfectNumber(28)); //expected output: true
        System.out.println(PerfectNumber.isPerfectNumber(5)); //expected output: false
        System.out.println(PerfectNumber.isPerfectNumber(-1)); //expected output: false
